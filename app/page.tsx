        ...
        <header className="bg-[linear-gradient(90deg,rgba(229,72,77,0.18),rgba(59,130,246,0.14)),rgba(15,23,42,0.55)] border-b border-white/10">
          <div className="flex items-center justify-between gap-4 p-4">
            ...
            <div className="flex gap-2.5">
              ...
              <button className="bg-linear-to-b from-[#22c55e] to-[#16a34a] border border-white/18 text-[#e8eefc] py-2.5 px-3.5 rounded-xl font-extrabold select-none active:translate-y-px">
                Log Out
              </button>
            </div>
          </div>
