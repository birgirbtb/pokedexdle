...
import { SlideDown } from "./Animated"; // ✅ NEW: animation wrapper
...
export default function SearchPokemon({
  ...
  /* ------------------------------------------------------------------------ */
  /* NEW: Computed flag for dropdown animation                               */
  /* ------------------------------------------------------------------------ */

  const dropdownOpen = showDropdown && results.length > 0 && !disabled;
